...
window.onload = function() {
    ...
    function init() {
      ...
      faux = document.getElementById('faux')
      ...
      // airport_fuel_truck_ref-orange.png
      // airport_fuel_truck_ref-grey.png
      // space_frigate_6_color.png
      loader.load( 'assets/objects/texture/space_frigate_6_color.png', function ( image ) {
        texture.image = image;
      ...
      //
      // airport_fuel_truck.obj
      // space_frigate_6.obj
      loader.load( 'assets/objects/obj/space_frigate_6.obj', function ( event ) {
        var object = event;
        ...
        object.scale = new THREE.Vector3( 2.5, 2.5, 2.5 );
      ...
      faux.appendChild( renderer.domElement );
    }
